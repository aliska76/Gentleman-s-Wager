...
/**
 * A handful of small inline-SVG icons — not worth a whole icon library
 * dependency (that I can't even install from here — see the sound feature
 * notes) for five glyphs. Each takes normal SVG props so size/color
 * (currentColor by default) can be overridden from the call site.
 */
